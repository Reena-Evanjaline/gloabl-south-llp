...
import { Modal, Form, Button } from 'react-bootstrap'; // Make sure react-bootstrap is installed
      ...
      <div className="container-fluid mt-2">
        <div className="row">
          ...
          <div className="col-lg-8" style={{ textAlign: 'justify' }}>
            ...
            <p className='mt-2'>✅ <strong>Curated B2B Meetings:</strong><br /> Engage in one-on-one sessions with vetted Indian enterprises — importers, distributors, OEMs, and channel partners.</p>
            ...
            <p className='mt-2'>✅ <strong>Exclusive Briefings:</strong><br /> Closed-door sessions with nodal ministries, business consultants, attorneys, and auditors to understand legal, tax, and regulatory environments.</p>
            <p className='mt-2'>✅ <strong>Industrial & Site Visits:</strong><br /> Guided visits to SEZs, industrial parks, local manufacturing units, and key infrastructure projects.</p>
            <p className='mt-2'>✅ <strong>Pan-India Market Exploration:</strong><br /> Cover multiple Indian cities in a single mission to assess regional opportunities and economic potential.</p>
            <p className='mt-2'>✅ <strong>Import Facilitation:</strong><br /> Support for pre-shipment of samples, brochures, and literature to ensure readiness for display and discussion.</p>
            <p className='mt-2'>✅ <strong>Logistics Management:</strong><br /> Full support for hotel bookings, local travel arrangements, interpreter services, and delegation kits.</p>
            <p className='mt-2'>✅ <strong>Pre-Mission Planning:</strong><br /> Regular client consultations to ensure agenda alignment, cultural fit, and outcomes-oriented programming.</p>
            ...
            <p>📩 <strong>Contact us today</strong> to design a tailor-made trade mission that delivers results — whether it's sector-specific, multi-industry, or investment-focused.</p>
            <p><strong>Let us be your trusted bridge to India.</strong></p>
          ...
          <div className="col-lg-4 d-flex flex-column ">
            ...
            />
            <h2><strong>Impact You Can Expect
            ...
            <strong><h2 className="fw-bold">Planning a trade mission</h2></strong>

            <div className="d-flex  gap-3 mt-3 w-100">
              <div className="d-flex border border-2 border-danger rounded-pill overflow-hidden">
              ...
              <button className="btn d-flex align-items-center bg-danger text-white rounded-pill px-4 py-2 border-0">
                <div className="bg-white text-danger d-flex align-items-center justify-content-center px-3 py-2 rounded-start-pill fs-5">
                  <BsEnvelopeFill />
                </div>
                <div className="px-3 fw-bold">Start Planning Now</div>
              </button>
            </div>
          </div>
